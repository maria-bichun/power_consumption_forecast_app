...
import datetime
import base64
from st_pages import Page, show_pages, add_page_title, show_pages_from_config, hide_pages
...
text = {'menu_home': {'en': 'Home', 'ru': 'Главная'},
        ...
        'preword': {'en': 'On this page you can select dates, get forecast in MWh and compare it to real power consumption for the corresponding period',
